// Type definitions for @metamx/node-zookeeper-client 0.2
// Project: https://github.com/metamx/node-zookeeper-client
...
export interface Client extends EventEmitter {
  ...
  removeAll(path: string, callback: (error: Error | Exception) => void): void;
  removeAll(path: string, version: number, callback: (error: Error | Exception) => void): void;
  ...
  getAllChildren(path: string, callback: (error: Error | Exception, children: string[], stat: Stat) => void): void;
